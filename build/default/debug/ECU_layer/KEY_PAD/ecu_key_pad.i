...
# 1 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/mcal_gpio.h" 1
# 12 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/mcal_gpio.h"
...
# 12 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/mcal_gpio.h" 2
...
# 13 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/mcal_gpio.h" 2

# 1 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/../mcal_std_types.h" 1
# 14 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 15 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 14 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/mcal_gpio.h" 2

# 1 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/../../MCAL_layer/device_config.h" 1
# 15 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/mcal_gpio.h" 2
# 31 "ECU_layer/KEY_PAD/../../MCAL_layer/GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
STD_ReturnType key_pad_initialization(const key_pad_t *KeyPad){
    ...
    uint8 l_rows_counter = 0 ; uint8 l_cols_counter = 0 ;
    if(((void*)0) == KeyPad){
        ...
        for(l_cols_counter = 0 ; l_cols_counter<3 ; l_cols_counter++){
            error_state = gpio_pin_direction_init(&(KeyPad->COLS_PINS[l_cols_counter]));
        }
    }
    return error_state ;
}
# 40 "ECU_layer/KEY_PAD/ecu_key_pad.c"
STD_ReturnType key_pad_get_value(const key_pad_t *KeyPad , uint8 *value){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    logic_t l_cols_logic = LOW ;
    uint8 l_rows_counter = 0 ; uint8 l_cols_counter = 0 ; uint8 l_counter = 0 ;
