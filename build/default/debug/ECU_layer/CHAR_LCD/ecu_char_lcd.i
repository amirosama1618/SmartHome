...
# 1 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/mcal_gpio.h" 1
# 12 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/mcal_gpio.h"
...
# 12 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/mcal_gpio.h" 2
...
# 25 "E:/Program Files/packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\\pic\\include\\xc.h" 2 3
...
# 13 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/mcal_gpio.h" 2

# 1 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/../mcal_std_types.h" 1
# 14 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 14 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/mcal_gpio.h" 2

# 1 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/../../MCAL_layer/device_config.h" 1
# 15 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/mcal_gpio.h" 2
# 31 "ECU_layer/CHAR_LCD/../../MCAL_layer/GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
STD_ReturnType chr_lcd_4bit_initialize(const chr_lcd_4bit_t *chr_lcd){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    ...
    if(chr_lcd == ((void*)0)){
        ...
        error_state &= chr_lcd_4bit_send_command(chr_lcd, 0x38);
        _delay((unsigned long)((5)*(8000000UL/4000.0)));
        error_state &= chr_lcd_4bit_send_command(chr_lcd, 0x38);
        _delay((unsigned long)((150)*(8000000UL/4000000.0)));
        error_state &= chr_lcd_4bit_send_command(chr_lcd, 0x38);
        error_state &= chr_lcd_4bit_send_command(chr_lcd, 0x01);
        error_state &= chr_lcd_4bit_send_command(chr_lcd, 0x02);
        error_state &= chr_lcd_4bit_send_command(chr_lcd, 0x06);
        error_state &= chr_lcd_4bit_send_command(chr_lcd, 0x0C);
        error_state &= chr_lcd_4bit_send_command(chr_lcd, 0x28);
...
# 92 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_4bit_send_char_data(const chr_lcd_4bit_t *chr_lcd, uint8 data){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(chr_lcd == ((void*)0)){
        error_state = (STD_ReturnType)0x00 ;
...
# 121 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_4bit_send_char_data_position(const chr_lcd_4bit_t *chr_lcd , uint8 row , uint8 column , uint8 data ){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(chr_lcd == ((void*)0)){
        error_state = (STD_ReturnType)0x00 ;
...
# 140 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_4bit_send_string_data(const chr_lcd_4bit_t *chr_lcd, uint8* str){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(chr_lcd == ((void*)0)){
        error_state = (STD_ReturnType)0x00 ;
...
# 186 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_4bit_send_custom_char(const chr_lcd_4bit_t *chr_lcd , uint8 row , uint8 column , const uint8 _chr[] , uint8 mem_pos){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    uint8 l_character_counter = 0 ;
    if(chr_lcd == ((void*)0)){
        error_state = (STD_ReturnType)0x00 ;
    }
    else{
        error_state &= chr_lcd_4bit_send_command(chr_lcd, 0x40 +(8*mem_pos));
        for(l_character_counter = 0 ; l_character_counter<=7 ;++l_character_counter){
...
# 209 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_8bit_initialize(const chr_lcd_8bit_t *chr_lcd){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    uint8 l_data_pin_counter = 0 ;
    if(chr_lcd == ((void*)0)){
        ...
        _delay((unsigned long)((20)*(8000000UL/4000.0)));
        error_state &= chr_lcd_8bit_send_command(chr_lcd , 0x38);
        _delay((unsigned long)((5)*(8000000UL/4000.0)));
        error_state &= chr_lcd_8bit_send_command(chr_lcd , 0x38);
        _delay((unsigned long)((150)*(8000000UL/4000000.0)));
        error_state &= chr_lcd_8bit_send_command(chr_lcd , 0x38);
        error_state &= chr_lcd_8bit_send_command(chr_lcd , 0x01);
        error_state &= chr_lcd_8bit_send_command(chr_lcd , 0x02);
        error_state &= chr_lcd_8bit_send_command(chr_lcd , 0x06);
        error_state &= chr_lcd_8bit_send_command(chr_lcd , 0x0C);
        error_state &= chr_lcd_8bit_send_command(chr_lcd , 0x38);
        error_state &= chr_lcd_8bit_send_command(chr_lcd , 0x40);
    }
    return error_state ;
}
# 244 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_8bit_send_command(const chr_lcd_8bit_t *chr_lcd, uint8 command){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(chr_lcd == ((void*)0)){
        error_state = (STD_ReturnType)0x00 ;
...
# 267 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_8bit_send_char_data(const chr_lcd_8bit_t *chr_lcd, uint8 data){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(chr_lcd == ((void*)0)){
        error_state = (STD_ReturnType)0x00 ;
...
# 293 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_8bit_send_char_data_position(const chr_lcd_8bit_t *chr_lcd , uint8 row , uint8 column , uint8 data ){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(chr_lcd == ((void*)0)){
        error_state = (STD_ReturnType)0x00 ;
...
# 312 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_8bit_send_string_data(const chr_lcd_8bit_t *chr_lcd, uint8* str){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(chr_lcd == ((void*)0)){
        error_state = (STD_ReturnType)0x00 ;
...
# 334 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_8bit_send_string_data_position(const chr_lcd_8bit_t *chr_lcd , uint8 row , uint8 column , uint8* str ){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(chr_lcd == ((void*)0)){
        error_state = (STD_ReturnType)0x00 ;
...
# 356 "ECU_layer/CHAR_LCD/ecu_char_lcd.c"
STD_ReturnType chr_lcd_8bit_send_custom_char(const chr_lcd_8bit_t *chr_lcd , uint8 row , uint8 column , const uint8 _chr[] , uint8 mem_pos){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    uint8 l_character_counter = 0 ;
    if(chr_lcd == ((void*)0)){
        ...
        error_state &= chr_lcd_8bit_send_command(chr_lcd, 0x40 +(8*mem_pos));
        for(l_character_counter = 0 ; l_character_counter<8 ;l_character_counter++){
...
static STD_ReturnType lcd_4bit_set_cursor_position(const chr_lcd_4bit_t *lcd , uint8 row , uint8 column){
    ...
    column -- ;
    switch (row){
        case 1: chr_lcd_4bit_send_command(lcd , (0x80 + column)); break ;
        case 2: chr_lcd_4bit_send_command(lcd , (0xc0 + column)); break ;
        case 3: chr_lcd_4bit_send_command(lcd , (0x94 + column)); break ;
        case 4: chr_lcd_4bit_send_command(lcd , (0xd4 + column)); break ;
        default : error_state = (STD_ReturnType)0x00 ;
    }
    return error_state ;
}
...
static STD_ReturnType lcd_send_8bits(const chr_lcd_8bit_t *lcd , uint8 _data_command){
    ...
    for(l_pin_counter = 0 ; l_pin_counter<8 ; l_pin_counter ++){
        error_state &= gpio_pin_write_logic(&(lcd->lcd_data[l_pin_counter]) ,
                                             (_data_command >> l_pin_counter) & (uint8)1);
    }
    return error_state ;
}
static STD_ReturnType lcd_8bit_send_enable_signal(const chr_lcd_8bit_t *lcd){
...
static STD_ReturnType lcd_8bit_set_cursor_position(const chr_lcd_8bit_t *lcd , uint8 row , uint8 column){
    ...
    column -- ;
    switch (row){
        case 1: chr_lcd_8bit_send_command(lcd , (0x80 + column)); break ;
        case 2: chr_lcd_8bit_send_command(lcd , (0xc0 + column)); break ;
        case 3: chr_lcd_8bit_send_command(lcd , (0x94 + column)); break ;
        case 4: chr_lcd_8bit_send_command(lcd , (0xd4 + column)); break ;
        default : error_state = (STD_ReturnType)0x00 ;
    }
    return error_state ;
}
