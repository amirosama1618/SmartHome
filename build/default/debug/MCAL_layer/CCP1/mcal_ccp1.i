...
# 2 "<built-in>" 2
# 1 "MCAL_layer/CCP1/mcal_ccp1.c" 2
...
# 1 "MCAL_layer/CCP1/mcal_ccp1.h" 1
# 12 "MCAL_layer/CCP1/mcal_ccp1.h"
...
# 12 "MCAL_layer/CCP1/mcal_ccp1.h" 2

# 1 "MCAL_layer/CCP1/../mcal_std_types.h" 1
# 14 "MCAL_layer/CCP1/../mcal_std_types.h"
...
# 13 "MCAL_layer/CCP1/mcal_ccp1.h" 2
...
# 1 "MCAL_layer/CCP1/../INTERRUPT/../GPIO/mcal_gpio.h" 1
# 15 "MCAL_layer/CCP1/../INTERRUPT/../GPIO/mcal_gpio.h"
# 1 "MCAL_layer/CCP1/../INTERRUPT/../GPIO/../../MCAL_layer/device_config.h" 1
# 15 "MCAL_layer/CCP1/../INTERRUPT/../GPIO/mcal_gpio.h" 2
# 31 "MCAL_layer/CCP1/../INTERRUPT/../GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 51 "MCAL_layer/CCP1/../INTERRUPT/mcal_interrupt_config.h"
...
# 15 "MCAL_layer/CCP1/mcal_ccp1.h" 2


# 1 "MCAL_layer/CCP1/../TIMER1/timer1.h" 1
# 86 "MCAL_layer/CCP1/../TIMER1/timer1.h"
typedef enum {
...
# 106 "MCAL_layer/CCP1/../TIMER3/timer3.h"
STD_ReturnType Timer3_Init(const timer3_config_t *timer3);
# 115 "MCAL_layer/CCP1/../TIMER3/timer3.h"
STD_ReturnType Timer3_DeInit(const timer3_config_t *timer3);
# 125 "MCAL_layer/CCP1/../TIMER3/timer3.h"
STD_ReturnType Timer3_Read_value(const timer3_config_t *timer3 , uint16 *value);
# 135 "MCAL_layer/CCP1/../TIMER3/timer3.h"
STD_ReturnType Timer3_Write_value(const timer3_config_t *timer3 , uint16 value);
# 19 "MCAL_layer/CCP1/mcal_ccp1.h" 2

# 1 "MCAL_layer/CCP1/mcal_ccp1_cfg.h" 1
# 20 "MCAL_layer/CCP1/mcal_ccp1.h" 2
# 62 "MCAL_layer/CCP1/mcal_ccp1.h"
typedef enum{
    CCP1_INST = 0,
    CCP2_INST
}ccp_inst_t;
...
static __attribute__((inline)) void ccp_capture_timer_config(const ccp_config_t *_ccp);
# 70 "MCAL_layer/CCP1/mcal_ccp1.c"
STD_ReturnType CCP_Init(const ccp_config_t *_ccp ){
...
# 142 "MCAL_layer/CCP1/mcal_ccp1.c"
            ...
            else{error_state = (STD_ReturnType)0x00 ;}




            if(((void*)0) == _ccp->ccp_InterruptHandler){
...
# 186 "MCAL_layer/CCP1/mcal_ccp1.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
                error_state = (STD_ReturnType)0x01 ;
...
# 258 "MCAL_layer/CCP1/mcal_ccp1.c"
            if(CCP_PWM_MODE_SELECTED == _ccp->ccp_mode){
            ...
            if(((void*)0) == _ccp->ccp_InterruptHandler){
                ...
                (PIR2bits.CCP2IF = 0);
                CCP1_InterruptHandler = _ccp->ccp_InterruptHandler ;
# 301 "MCAL_layer/CCP1/mcal_ccp1.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
                error_state = (STD_ReturnType)0x01 ;
...
# 323 "MCAL_layer/CCP1/mcal_ccp1.c"
STD_ReturnType CCP_DeInit(const ccp_config_t *_ccp ){
    STD_ReturnType error_state =(STD_ReturnType)0x00 ;
    if(((void*)0) == _ccp){
        error_state = (STD_ReturnType)0x00 ;
...
# 526 "MCAL_layer/CCP1/mcal_ccp1.c"
STD_ReturnType CCP_PWMSetDuty(const ccp_config_t *_ccp, const uint8 _duty){
    STD_ReturnType error_state =(STD_ReturnType)0x00 ;
    uint16 l_temp_duty = 0 ;
...
# 554 "MCAL_layer/CCP1/mcal_ccp1.c"
STD_ReturnType CCP_PWMStart(const ccp_config_t *_ccp){
    STD_ReturnType error_state =(STD_ReturnType)0x00 ;
    if(CCP1_INST == _ccp->ccp_inst){
        (CCP1CONbits.CCP1M = ((uint8)0x0C));
...
# 578 "MCAL_layer/CCP1/mcal_ccp1.c"
STD_ReturnType CCP_PWMEnd(const ccp_config_t *_ccp){
    STD_ReturnType error_state =(STD_ReturnType)0x00 ;
    if(CCP1_INST == _ccp->ccp_inst){
        (CCP1CONbits.CCP1M = 0x00);
