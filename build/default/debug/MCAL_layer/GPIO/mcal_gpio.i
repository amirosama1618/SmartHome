...
STD_ReturnType gpio_pin_direction_init(const pin_config_t *_pin_config){
    ...
    if(((void*)0) == _pin_config ){
        ...
        switch(_pin_config->direction){
            case OUTPUT :
                (*tris_regs[_pin_config->port] &=~((uint8)1<<_pin_config->pin));
                break ;
            case INPUT :
                (*tris_regs[_pin_config->port] |= ((uint8)1<<_pin_config->pin));
                break ;
...
# 49 "MCAL_layer/GPIO/mcal_gpio.c"
STD_ReturnType gpio_pin_get_direction_status(const pin_config_t *_pin_config, direction_t *direction_status){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(((void*)0) == _pin_config || ((void*)0) == direction_status || _pin_config->pin > 7){
        ...
        switch(((*tris_regs[_pin_config->port] >> _pin_config->pin) & (uint8)1)){
            case OUTPUT :
...
# 75 "MCAL_layer/GPIO/mcal_gpio.c"
STD_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_config, logic_t logic){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(((void*)0) == _pin_config ){
        error_state = (STD_ReturnType)0x00 ;
        ...
        switch(logic){
            case LOW :
                (*lat_regs[_pin_config->port] &=~((uint8)1<<_pin_config->pin)) ;
                break ;
            case HIGH :
                (*lat_regs[_pin_config->port] |= ((uint8)1<<_pin_config->pin)) ;
                break ;
...
# 101 "MCAL_layer/GPIO/mcal_gpio.c"
STD_ReturnType gpio_pin_read_logic(const pin_config_t *_pin_config, logic_t *logic){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(((void*)0) == _pin_config || ((void*)0) == logic || _pin_config->pin > 7){
        ...
        switch(((*port_regs[_pin_config->port] >> _pin_config->pin) & (uint8)1)){
            case LOW :
                *logic = LOW ;
                break ;
            case HIGH :
...
# 163 "MCAL_layer/GPIO/mcal_gpio.c"
STD_ReturnType gpio_port_direction_init(port_index_t port , direction_t direction){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(port > 4){
        error_state = (STD_ReturnType)0x00 ;
...
# 181 "MCAL_layer/GPIO/mcal_gpio.c"
STD_ReturnType gpio_port_get_direction_status(port_index_t port , direction_t *dic_status){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(port > 4 || ((void*)0) == dic_status){
        error_state = (STD_ReturnType)0x00 ;
    }
    else{
...
# 199 "MCAL_layer/GPIO/mcal_gpio.c"
STD_ReturnType gpio_port_write_logic(port_index_t port,logic_t logic){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if(port > 4 ){
        error_state = (STD_ReturnType)0x00 ;
...
# 222 "MCAL_layer/GPIO/mcal_gpio.c"
STD_ReturnType gpio_port_read_logic(port_index_t port,logic_t *logic){
    STD_ReturnType error_state = (STD_ReturnType)0x01 ;
    if( port > 4 || ((void*)0) == logic){
        error_state = (STD_ReturnType)0x00 ;
    }
    else{
        *logic = *lat_regs[port] ;
