...
# 12 "MCAL_layer/ADC/mcal_adc.h" 2

# 1 "MCAL_layer/ADC/../../MCAL_layer/mcal_std_types.h" 1
# 14 "MCAL_layer/ADC/../../MCAL_layer/mcal_std_types.h"
...
# 13 "MCAL_layer/ADC/../../MCAL_layer/compiler.h" 2
...
# 1 "MCAL_layer/ADC/../GPIO/mcal_gpio.h" 1
# 15 "MCAL_layer/ADC/../GPIO/mcal_gpio.h"
# 1 "MCAL_layer/ADC/../GPIO/../../MCAL_layer/device_config.h" 1
# 15 "MCAL_layer/ADC/../GPIO/mcal_gpio.h" 2
# 31 "MCAL_layer/ADC/../GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 51 "MCAL_layer/ADC/../INTERRUPT/mcal_interrupt_config.h"
...
static __attribute__((inline)) void adc_input_cahnnel_port_configure(adc_channel_select_t channel );
static __attribute__((inline)) void adc_configure_result_format(const adc_conf_t *adc_obj);
static __attribute__((inline)) void adc_configure_voltage_refrence(const adc_conf_t *adc_obj);
# 31 "MCAL_layer/ADC/mcal_adc.c"
STD_ReturnType ADC_Init(const adc_conf_t *adc_obj){
    ...
    if(((void*)0) == adc_obj){
        ...
        (ADCON2bits.ACQT = adc_obj->aquisition_time);

        (ADCON2bits.ADCS = adc_obj->conversion_clock);

        (ADCON0bits.CHS = adc_obj->channel_select);
...
STD_ReturnType ADC_GetConversionResult(const adc_conf_t *adc_obj, adc_result_t *conversion_result){
    ...
    if((((void*)0) == adc_obj) || (((void*)0) == conversion_result)){
        ...
        if(1 == adc_obj->Result_format){
            *conversion_result = (adc_result_t)((ADRESH<<8)+ADRESL);
        }
        else if(0 == adc_obj->Result_format){
...
STD_ReturnType ADC_GetConversion_Interrrupt(const adc_conf_t *adc_obj, adc_channel_select_t channel ,
    ...
    if((((void*)0) == adc_obj) || (((void*)0) == conversion_result)){
        ...
        while(l_conversion_status == 0);
        error_state = ADC_GetConversionResult(adc_obj , conversion_result);

    }
    return error_state ;
}
# 245 "MCAL_layer/ADC/mcal_adc.c"
STD_ReturnType ADC_StartConversion_Interrupt(const adc_conf_t *adc_obj, adc_channel_select_t channel){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    uint8 l_conversion_status = 0 ;
    if((((void*)0) == adc_obj)){
...
static __attribute__((inline)) void adc_configure_voltage_refrence(const adc_conf_t *adc_obj){
    if(1 == adc_obj->voltage_reference){
            do{ ADCON1bits.VCFG1 = 1; ADCON1bits.VCFG0 = 1; }while(0);
        }
        else if(0 == adc_obj->voltage_reference){
...
static STD_ReturnType Interrupt_ADC_Init(const adc_conf_t *adc_obj){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    if((((void*)0) == adc_obj) || (((void*)0) == adc_obj->ADC_InterruptHandler)){
        error_state = (STD_ReturnType)0x00 ;
    }
    else{
