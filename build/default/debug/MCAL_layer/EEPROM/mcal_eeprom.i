...
# 13 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/mcal_gpio.h"
...
# 14 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/../mcal_std_types.h"
# 1 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/../std_libraries.h" 1
# 13 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/../std_libraries.h"
...
# 13 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/../std_libraries.h" 2
...
# 14 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/../mcal_std_types.h" 2

# 1 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/../compiler.h" 1
# 15 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/../mcal_std_types.h" 2
...
# 14 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/mcal_gpio.h" 2

# 1 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/../../MCAL_layer/device_config.h" 1
# 15 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/mcal_gpio.h" 2
# 31 "MCAL_layer/EEPROM/../INTERRUPT/../GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 51 "MCAL_layer/EEPROM/../INTERRUPT/mcal_interrupt_config.h"
...
# 30 "MCAL_layer/EEPROM/mcal_eeprom.h"
...
# 18 "MCAL_layer/EEPROM/mcal_eeprom.c"
STD_ReturnType EEPROM_Data_WriteByte(uint16 bAdd, uint8 bData){
...
STD_ReturnType EEPROM_Data_Write(uint16 bAdd,uint8 *bData){
    ...
    if(((void*)0) == bData){
        ...
        for (uint16_t i = 0; bData[i] != ((void*)0) ; i++) {
            error_state = EEPROM_Data_WriteByte(bAdd + i, bData[i]);
        }
    }
    return error_state ;
}
# 73 "MCAL_layer/EEPROM/mcal_eeprom.c"
STD_ReturnType EEPROM_Data_ReadByte(uint16 bAdd, uint8 *bData){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    if(((void*)0) == bData){
        error_state = (STD_ReturnType)0x00;
