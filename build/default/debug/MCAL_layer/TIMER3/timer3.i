...
# 13 "MCAL_layer/TIMER3/../../MCAL_layer/compiler.h"
...
# 13 "MCAL_layer/TIMER3/../../MCAL_layer/compiler.h" 2
# 12 "MCAL_layer/TIMER3/timer3.h" 2

# 1 "MCAL_layer/TIMER3/../../MCAL_layer/device_config.h" 1
...
# 16 "MCAL_layer/TIMER3/../../MCAL_layer/std_libraries.h" 2
# 14 "MCAL_layer/TIMER3/timer3.h" 2

# 1 "MCAL_layer/TIMER3/../../MCAL_layer/mcal_std_types.h" 1
# 18 "MCAL_layer/TIMER3/../../MCAL_layer/mcal_std_types.h"
...
# 1 "MCAL_layer/TIMER3/../GPIO/mcal_gpio.h" 1
# 31 "MCAL_layer/TIMER3/../GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 51 "MCAL_layer/TIMER3/../INTERRUPT/mcal_interrupt_config.h"
...
# 18 "MCAL_layer/TIMER3/timer3.h" 2
# 62 "MCAL_layer/TIMER3/timer3.h"
typedef enum {
...
# 106 "MCAL_layer/TIMER3/timer3.h"
STD_ReturnType Timer3_Init(const timer3_config_t *timer3);
# 115 "MCAL_layer/TIMER3/timer3.h"
STD_ReturnType Timer3_DeInit(const timer3_config_t *timer3);
# 125 "MCAL_layer/TIMER3/timer3.h"
STD_ReturnType Timer3_Read_value(const timer3_config_t *timer3 , uint16 *value);
# 135 "MCAL_layer/TIMER3/timer3.h"
STD_ReturnType Timer3_Write_value(const timer3_config_t *timer3 , uint16 value);
# 9 "MCAL_layer/TIMER3/timer3.c" 2


uint16 g_timer3_preload_value = 0 ;


static InterruptHandler Timer3_InterruptHandler = ((void*)0) ;


static __attribute__((inline)) void TIMER3_MODE_CONFIGURE(const timer3_config_t *timer3);
static __attribute__((inline)) void TIMER3_RW_MODE_CONFIGURE(const timer3_config_t *timer3);
# 28 "MCAL_layer/TIMER3/timer3.c"
STD_ReturnType Timer3_Init(const timer3_config_t *timer3){
...
# 110 "MCAL_layer/TIMER3/timer3.c"
STD_ReturnType Timer3_Read_value(const timer3_config_t *timer3 , uint16 *value){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
...
# 133 "MCAL_layer/TIMER3/timer3.c"
STD_ReturnType Timer3_Write_value(const timer3_config_t *timer3 , uint16 value){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    if(((void*)0) == timer3){
        error_state = (STD_ReturnType)0x00 ;
