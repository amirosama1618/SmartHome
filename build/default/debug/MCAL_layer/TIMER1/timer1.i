...
# 21 "MCAL_layer/TIMER1/timer1.h" 2

# 1 "MCAL_layer/TIMER1/../../MCAL_layer/compiler.h" 1
# 13 "MCAL_layer/TIMER1/../../MCAL_layer/compiler.h"
...
# 13 "MCAL_layer/TIMER1/../../MCAL_layer/compiler.h" 2
# 22 "MCAL_layer/TIMER1/timer1.h" 2

# 1 "MCAL_layer/TIMER1/../../MCAL_layer/device_config.h" 1
# 23 "MCAL_layer/TIMER1/timer1.h" 2

# 1 "MCAL_layer/TIMER1/../../MCAL_layer/std_libraries.h" 1
# 13 "MCAL_layer/TIMER1/../../MCAL_layer/std_libraries.h"
...
# 16 "MCAL_layer/TIMER1/../../MCAL_layer/std_libraries.h" 2
# 24 "MCAL_layer/TIMER1/timer1.h" 2

# 1 "MCAL_layer/TIMER1/../../MCAL_layer/mcal_std_types.h" 1
# 18 "MCAL_layer/TIMER1/../../MCAL_layer/mcal_std_types.h"
...
# 25 "MCAL_layer/TIMER1/timer1.h" 2


# 1 "MCAL_layer/TIMER1/../GPIO/mcal_gpio.h" 1
# 31 "MCAL_layer/TIMER1/../GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 27 "MCAL_layer/TIMER1/timer1.h" 2
...
# 51 "MCAL_layer/TIMER1/../INTERRUPT/mcal_interrupt_config.h"
...
# 28 "MCAL_layer/TIMER1/timer1.h" 2
# 86 "MCAL_layer/TIMER1/timer1.h"
typedef enum {
...
# 110 "MCAL_layer/TIMER1/timer1.c"
STD_ReturnType Timer1_Write_value(const timer1_config_t *timer1 , uint16 value){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    if(((void*)0) == timer1){
        error_state = (STD_ReturnType)0x00 ;
...
static STD_ReturnType timer1_prescaler_configure(const timer1_config_t *timer1){
    ...
    switch(timer1->timer1_prescaler_value){
        case TIMER1_PRESCALER_DIV_1 :
            (T1CONbits.T1CKPS = TIMER1_PRESCALER_DIV_1);
            error_state = (STD_ReturnType)0x01 ;
            break ;
        case TIMER1_PRESCALER_DIV_2 :
            (T1CONbits.T1CKPS = TIMER1_PRESCALER_DIV_2);
            error_state = (STD_ReturnType)0x01 ;
            break ;
        case TIMER1_PRESCALER_DIV_4 :
            (T1CONbits.T1CKPS = TIMER1_PRESCALER_DIV_4);
            error_state = (STD_ReturnType)0x01 ;
            break ;
        case TIMER1_PRESCALER_DIV_8 :
            (T1CONbits.T1CKPS = TIMER1_PRESCALER_DIV_8);
            error_state = (STD_ReturnType)0x01 ;
            break ;
...
static STD_ReturnType timer1_interrupt_configure(const timer1_config_t *timer1){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    if(((void*)0) == timer1->Timer1_Interrupt){
        error_state = (STD_ReturnType)0x00 ;
    }
    else{
        (PIE1bits.TMR1IE = 0);
...
# 234 "MCAL_layer/TIMER1/timer1.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
        error_state = (STD_ReturnType)0x01 ;
