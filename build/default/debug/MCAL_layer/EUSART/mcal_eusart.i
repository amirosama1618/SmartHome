...
# 16 "MCAL_layer/EUSART/mcal_eusart.h"
...
# 16 "MCAL_layer/EUSART/mcal_eusart.h" 2
...
# 17 "MCAL_layer/EUSART/mcal_eusart.h" 2

# 1 "MCAL_layer/EUSART/../mcal_std_types.h" 1
# 15 "MCAL_layer/EUSART/../mcal_std_types.h"
...
# 15 "MCAL_layer/EUSART/../mcal_std_types.h" 2
...
# 18 "MCAL_layer/EUSART/mcal_eusart.h" 2

# 1 "MCAL_layer/EUSART/../GPIO/mcal_gpio.h" 1
# 15 "MCAL_layer/EUSART/../GPIO/mcal_gpio.h"
# 1 "MCAL_layer/EUSART/../GPIO/../../MCAL_layer/device_config.h" 1
# 15 "MCAL_layer/EUSART/../GPIO/mcal_gpio.h" 2
# 31 "MCAL_layer/EUSART/../GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 19 "MCAL_layer/EUSART/mcal_eusart.h" 2
...
# 15 "MCAL_layer/EUSART/../INTERRUPT/mcal_interrupt_config.h"
# 1 "MCAL_layer/EUSART/../INTERRUPT/mcal_interrupt_gen_config.h" 1
# 15 "MCAL_layer/EUSART/../INTERRUPT/mcal_interrupt_config.h" 2
# 51 "MCAL_layer/EUSART/../INTERRUPT/mcal_interrupt_config.h"
...
# 20 "MCAL_layer/EUSART/mcal_eusart.h" 2

# 1 "MCAL_layer/EUSART/mcal_eusart_cfg.h" 1
# 21 "MCAL_layer/EUSART/mcal_eusart.h" 2
# 76 "MCAL_layer/EUSART/mcal_eusart.h"
typedef enum{
...
# 137 "MCAL_layer/EUSART/mcal_eusart.h"
...
# 154 "MCAL_layer/EUSART/mcal_eusart.h"
...
# 177 "MCAL_layer/EUSART/mcal_eusart.h"
STD_ReturnType EUSART_ASYNC_WrireByteBlocking(uint8 data);
# 187 "MCAL_layer/EUSART/mcal_eusart.h"
STD_ReturnType EUSART_ASYNC_WrireStringBlocking(uint8 *data , uint16 str_len);
# 9 "MCAL_layer/EUSART/mcal_eusart.c" 2



InterruptHandler EUSART_ASYNC_TX_InterruptHandler = ((void*)0) ;


InterruptHandler EUSART_ASYNC_RX_InterruptHandler = ((void*)0) ;
static void(* EUSART_ASYNC_FramingErrorHandler)(void) = ((void*)0) ;
static void(* EUSART_ASYNC_OverRunErrorHandler)(void) = ((void*)0) ;


static __attribute__((inline)) void eusart_async_baudrate_calculation(const usart_async_t * _eusart);
static __attribute__((inline)) void eusart_async_tx_configure(const usart_async_t * _eusart);
static __attribute__((inline)) void eusart_async_rx_configure(const usart_async_t * _eusart);
# 35 "MCAL_layer/EUSART/mcal_eusart.c"
STD_ReturnType EUSART_ASYNC_Init(const usart_async_t * _eusart){
...
# 85 "MCAL_layer/EUSART/mcal_eusart.c"
STD_ReturnType EUSART_ASYNC_ReadByteBlocking(uint8 * _data){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    while(!PIR1bits.RCIF);
    *_data = RCREG ;
...
# 125 "MCAL_layer/EUSART/mcal_eusart.c"
STD_ReturnType EUSART_ASYNC_WrireByteBlocking(uint8 data){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
...
# 144 "MCAL_layer/EUSART/mcal_eusart.c"
STD_ReturnType EUSART_ASYNC_WrireStringBlocking(uint8 *data , uint16 str_len){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
...
static __attribute__((inline)) void eusart_async_baudrate_calculation(const usart_async_t * _eusart){
    ...
    switch (_eusart->baudrate_gen_mode){
            case BAUDRATE_ASYNC_8BIT_LOW_SPEED :
                ...
                BAUDCONbits.BRG16 = 0 ;
                TXSTAbits. SYNC = 0 ;
                BRG_value = ((8000000UL/(float)(_eusart->baudrate))/64)-1 ;
            ...
            case BAUDRATE_ASYNC_8BIT_HIGH_SPEED :
                ...
                BAUDCONbits.BRG16 = 0 ;
                TXSTAbits. SYNC = 0 ;
                BRG_value = ((8000000UL/(float)(_eusart->baudrate))/16)-1 ;
                SPBRG = (uint8)((uint32)BRG_value) ;
                break ;
            ...
            case BAUDRATE_ASYNC_16BIT_HIGH_SPEED :
                ...
                BAUDCONbits.BRG16 = 1 ;
                TXSTAbits. SYNC = 0 ;
                BRG_value = ((8000000UL/(float)(_eusart->baudrate))/4)-1 ;
                SPBRG = (uint8)((uint32)BRG_value) ;
                SPBRGH = (uint8)(((uint32)BRG_value)>>8) ;
                break ;
...
static __attribute__((inline)) void eusart_async_tx_configure(const usart_async_t * _eusart){
    if(_eusart->tx_cfg.eusart_tx_enable == 0){
        (TXSTAbits.TXEN = 0);
    }
    else if(_eusart->tx_cfg.eusart_tx_enable == 1){
        (TXSTAbits.TXEN = 1);

        if(_eusart->tx_cfg.eusart_tx_interrupt_enable == 0){
            (PIE1bits.TXIE = 0);
        }

        else if(_eusart->tx_cfg.eusart_tx_interrupt_enable == 1){

            EUSART_ASYNC_TX_InterruptHandler = _eusart->EUSART_TXDefaultInterruptHandler ;
# 232 "MCAL_layer/EUSART/mcal_eusart.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);
        ...
        if(_eusart->tx_cfg.eusart_tx_9bit_enable == 0){
            (TXSTAbits.TX9 = 0);
        }
        else if(_eusart->tx_cfg.eusart_tx_9bit_enable == 1){
            (TXSTAbits.TX9 = 1);
        }
        else{ }
    }
...
static __attribute__((inline)) void eusart_async_rx_configure(const usart_async_t * _eusart){
    if(_eusart->rx_cfg.eusart_rx_enable == 0){
        (RCSTAbits.CREN = 0);
    }
    else if(_eusart->rx_cfg.eusart_rx_enable == 1){
        (RCSTAbits.CREN = 1);

        if(_eusart->rx_cfg.eusart_rx_interrupt_enable == 0){
            (PIE1bits.RCIE = 0);
        }

        else if(_eusart->rx_cfg.eusart_rx_interrupt_enable == 1){
...
# 280 "MCAL_layer/EUSART/mcal_eusart.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);
        ...
        if(_eusart->rx_cfg.eusart_rx_9bit_enable == 0){
            (RCSTAbits.RX9 = 0);
        }
        else if(_eusart->rx_cfg.eusart_rx_9bit_enable == 1){
            (RCSTAbits.RX9 = 1);
        }
        else{ }
    }
