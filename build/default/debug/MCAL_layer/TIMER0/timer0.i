...
# 19 "MCAL_layer/TIMER0/timer0.h" 2

# 1 "MCAL_layer/TIMER0/../../MCAL_layer/compiler.h" 1
# 13 "MCAL_layer/TIMER0/../../MCAL_layer/compiler.h"
...
# 13 "MCAL_layer/TIMER0/../../MCAL_layer/compiler.h" 2
# 20 "MCAL_layer/TIMER0/timer0.h" 2

# 1 "MCAL_layer/TIMER0/../../MCAL_layer/device_config.h" 1
# 21 "MCAL_layer/TIMER0/timer0.h" 2

# 1 "MCAL_layer/TIMER0/../../MCAL_layer/std_libraries.h" 1
# 13 "MCAL_layer/TIMER0/../../MCAL_layer/std_libraries.h"
...
# 16 "MCAL_layer/TIMER0/../../MCAL_layer/std_libraries.h" 2
# 22 "MCAL_layer/TIMER0/timer0.h" 2

# 1 "MCAL_layer/TIMER0/../../MCAL_layer/mcal_std_types.h" 1
# 18 "MCAL_layer/TIMER0/../../MCAL_layer/mcal_std_types.h"
...
# 23 "MCAL_layer/TIMER0/timer0.h" 2


# 1 "MCAL_layer/TIMER0/../GPIO/mcal_gpio.h" 1
# 31 "MCAL_layer/TIMER0/../GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 25 "MCAL_layer/TIMER0/timer0.h" 2
...
# 51 "MCAL_layer/TIMER0/../INTERRUPT/mcal_interrupt_config.h"
...
# 26 "MCAL_layer/TIMER0/timer0.h" 2
...
uint16 g_timer0_preload_value = 0 ;
...
# 123 "MCAL_layer/TIMER0/timer0.c"
STD_ReturnType Timer0_Write_Value(const timer0_config_t *timer0_obj, uint16 _value){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    if(((void*)0) == timer0_obj){
        error_state = (STD_ReturnType)0x00 ;
...
static STD_ReturnType timer0_PreScalerConfigure(const timer0_config_t *timer0_obj){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    if(1 == timer0_obj->timer0_prescaler_cfg){

        (T0CONbits.PSA = 0);
        error_state = timer0_PreScalerValueConfigure(timer0_obj);
        error_state = (STD_ReturnType)0x01 ;
    }
    else if(0 == timer0_obj->timer0_prescaler_cfg){
...
static STD_ReturnType timer0_PreScalerValueConfigure(const timer0_config_t *timer0_obj){
    ...
    switch(timer0_obj->timer0_prescaler_value){
            case TIMER0_PRESCALER_DIV_BY_2 :
                (T0CONbits.T0PS = TIMER0_PRESCALER_DIV_BY_2);
                break;
           case TIMER0_PRESCALER_DIV_BY_4 :
                (T0CONbits.T0PS = TIMER0_PRESCALER_DIV_BY_4);
                break;
           case TIMER0_PRESCALER_DIV_BY_8 :
                (T0CONbits.T0PS = TIMER0_PRESCALER_DIV_BY_8);
                break;
           case TIMER0_PRESCALER_DIV_BY_16 :
                (T0CONbits.T0PS = TIMER0_PRESCALER_DIV_BY_16);
                break;
            case TIMER0_PRESCALER_DIV_BY_32 :
                (T0CONbits.T0PS = TIMER0_PRESCALER_DIV_BY_32);
                break;
           case TIMER0_PRESCALER_DIV_BY_64 :
                (T0CONbits.T0PS = TIMER0_PRESCALER_DIV_BY_64);
                break;
           case TIMER0_PRESCALER_DIV_BY_128 :
                (T0CONbits.T0PS = TIMER0_PRESCALER_DIV_BY_128);
                break;
           case TIMER0_PRESCALER_DIV_BY_256 :
                (T0CONbits.T0PS = TIMER0_PRESCALER_DIV_BY_256);
                break;
...
static STD_ReturnType timer0_InterruptConfigure(const timer0_config_t *timer0_obj){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    if(((void*)0) == timer0_obj->Timer0Interrupt){
        error_state = (STD_ReturnType)0x00 ;
    }
    else{

        (INTCONbits.TMR0IE = 0);
# 298 "MCAL_layer/TIMER0/timer0.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
        error_state = (STD_ReturnType)0x01 ;
