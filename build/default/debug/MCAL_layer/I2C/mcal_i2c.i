...
# 12 "MCAL_layer/I2C/mcal_i2c.h" 2

# 1 "MCAL_layer/I2C/../GPIO/mcal_gpio.h" 1
# 13 "MCAL_layer/I2C/../GPIO/mcal_gpio.h"
...
# 13 "MCAL_layer/I2C/../GPIO/mcal_gpio.h" 2

# 1 "MCAL_layer/I2C/../GPIO/../mcal_std_types.h" 1
# 14 "MCAL_layer/I2C/../GPIO/../mcal_std_types.h"
...
# 15 "MCAL_layer/I2C/../GPIO/../mcal_std_types.h" 2
...
# 14 "MCAL_layer/I2C/../GPIO/mcal_gpio.h" 2

# 1 "MCAL_layer/I2C/../GPIO/../../MCAL_layer/device_config.h" 1
# 15 "MCAL_layer/I2C/../GPIO/mcal_gpio.h" 2
# 31 "MCAL_layer/I2C/../GPIO/mcal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 51 "MCAL_layer/I2C/../INTERRUPT/mcal_interrupt_config.h"
...
static __attribute__((inline)) void mssp_i2c_mode_select(const mssp_i2c_t* i2c_obj);
static __attribute__((inline)) void mssp_i2c_mode_master_clock_configurations(const mssp_i2c_t* i2c_obj);
static __attribute__((inline)) void mssp_i2c_mode_slave_configurations(const mssp_i2c_t* i2c_obj);
static __attribute__((inline)) void mssp_i2c_mode_gpio_cfg(void);
static __attribute__((inline)) void mssp_i2c_mode_slew_rate_cfg(const mssp_i2c_t* i2c_obj);
static __attribute__((inline)) void mssp_i2c_mode_SMBus_rate_cfg(const mssp_i2c_t* i2c_obj);
# 35 "MCAL_layer/I2C/mcal_i2c.c"
STD_ReturnType MSSP_I2C_Init(const mssp_i2c_t* i2c_obj){
...
# 177 "MCAL_layer/I2C/mcal_i2c.c"
STD_ReturnType MSSP_I2C_Master_Write_Blocking(const mssp_i2c_t* i2c_obj , uint8 i2c_data , uint8 *i2c_ack){
    STD_ReturnType error_state = (STD_ReturnType)0x00 ;
    if((((void*)0) == i2c_obj) || (((void*)0) == i2c_ack)){
        error_state = (STD_ReturnType)0x00 ;
    }
    else{
...
static __attribute__((inline)) void mssp_i2c_mode_master_clock_configurations(const mssp_i2c_t* i2c_obj){
    ...
    SSPADD = (uint8)(((8000000UL / 4.0) / i2c_obj->i2c_master_clock_freq) - 1);
}
static __attribute__((inline)) void mssp_i2c_mode_slave_configurations(const mssp_i2c_t* i2c_obj){
    (SSPCON1bits.SSPM = i2c_obj->i2c_cfg.i2c_mode_cfg);
}
...
static __attribute__((inline)) void mssp_i2c_mode_SMBus_rate_cfg(const mssp_i2c_t* i2c_obj){
    if(1 ==i2c_obj->i2c_cfg.i2c_SM_bus_control){
        (SSPSTATbits.CKE = 0);
    }
    else if(0 ==i2c_obj->i2c_cfg.i2c_SM_bus_control){
        (SSPSTATbits.CKE = 0);
    }
    else{ }
}
